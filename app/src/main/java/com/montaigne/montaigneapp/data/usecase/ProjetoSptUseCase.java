...
public class ProjetoSptUseCase {
    ...
    public static void delete(ProjetoSpt projetoSpt) {
        ...
        projetoSptDao.deleteProjetoById(projetoSpt.getId()).addOnCompleteListener(task -> Log.i("Firebase", "Sucesso ao deletar projeto")).addOnFailureListener(exception -> Log.e("Firebase", "Falha ao deletar projeto"));
    }
    ...
    public static void read(ModelHolder<Projeto> holder) {
        ...
        try {
            ...
            Log.e("Firebase", "Falha ao configurar persistência de projetos. Detalhes: "+e.getMessage());
        }
