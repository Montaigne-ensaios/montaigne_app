...
public class CarimboProjetoAdapter extends RecyclerView.Adapter<BindedViewHolder<AdapterCarimboProjetoBinding>> {
    ...
    private void setProjeto(Projeto projeto) {
        fields.add(new Field("nome", projeto.getNome(), R.string.registration_projectName_hint, "Obrigatorio", R.drawable.ic_name_project));
        fields.add(new Field("cliente", projeto.getCliente(), R.string.HintAdapterCarimboProjetoCliente, "msgErro", R.drawable.ic_perfil));  // todo: replace icon
        ...
        fields.add(new Field("dataInicio", projeto.getDataInicio(), R.string.HintAdapterCarimboProjetoDataInicio, "msgErro", R.drawable.ic_date));
        fields.add(new Field("coordenadas", "", R.string.HintAdapterCarimboProjetoLocalObra, "msgErro", R.drawable.ic_location));
